			...
			<div class="modal-content">
				...
				<div class="modal-body text-gray-800">
					<div class="quality-box text-center">
						<div class="inner-box">
							<a class="btn-quality text-uppercase d-block py-3 border-bottom"
								href="/language?c=zh-TW&amp;r=https%3A%2F%2Fwww.mouggan.com%2Fen-us%2Frecent">繁中</a>
							<a class="btn-quality text-uppercase d-block py-3 "
								href="/language?c=en-US&amp;r=https%3A%2F%2Fwww.mouggan.com%2Fen-us%2Frecent">EN</a>
	...
	<header class="header" id="one">
		<div
			...
			<div class="header-inner">
				<div class="logo">
					<a href="/ec_p1_main.html"><img class="img-fluid"
				...
				<div class="navbar-nav">
					...
					<ul class="main-list member-nav">
						...
						<!-- 右上會員 -->
						<li class="nav-item hide-search"><a
							href="/en-us/user/account">
										...
										<li class="my-3">
											<div style="padding: 10px 30px">
												<a class="btn btn-outline-primary w-100"
													style="font-size: 16px;" href="<c:url value="/en-us/logout" />" title="登出">登出</a>
											</div>
										</li>
									</ol>
								</c:if>
								...
								<c:if test="${empty membersbean}">
									<ol class="sub-list p-4" style="height: 110px;">
										<li class="my-3">
											<div style="padding: 10px 30px">
												<a class="btn btn-outline-primary w-100"
													style="font-size: 16px;" href="<c:url value="/secure/ec_p3_login" />"
													title="登入">登入</a>
											</div>
										</li>
									</ol>
						...
						<li class="nav-item nav-change"><a class="nav"
							...
							<div class="sub-list-block down-left">
								<ol class="sub-list"
									...
									<li><a href="#">消化健康</a></li>
									<li><a href="#">能量精力</a></li>
									<li><a href="#">眼與視覺健康</a></li>
									<li><a href="#">免疫健康</a></li>
									<li><a href="#">健康睡眠</a></li>
									<li><a href="#">減重塑形</a></li>
									<li><a href="#">骨與關節健康</a></li>
								</ol>
							</div></li>
						<li class="nav-item"><a href="/mainpage.html"
	...
	<div id="main-wrap" style="font-size: 16px;">
		<div class="container-fluid">
			<div class="content-block content-xs">
				<form class="show-block show-register hide" id="form-user-login"
					...
					<div class="form-g">
						<c:if test="${not empty errors.birthday }">
							<input class="form-control" type="text"
								placeholder="${errors.birthday}" name="birthday" required
					...
					<input class="btn btn-outline-primary btn-block btn-lg"
						type="submit" value="註冊" style="font-size: 16px;">
				</form>
				<form class="show-block show-login" id="form-user-login"
					...
					<div class="form-g">
						<div class="float-left">
							<a class="d-inline-block mr-4" href="/en-us/Login/OAuth/1"> <i
								class="icon-fb" style="width: 30px; height: 30px"></i>
							</a>
						</div>
