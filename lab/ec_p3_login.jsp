...
<body id="page-shop" class="style-lang-en">
    ...
    <div id="main-wrap" style="font-size: 16px;">
        <div class="container-fluid">
            <div class="content-block content-xs">
                <form class="show-block show-register hide" id="form-register" action='<c:url value="/en-us/signup"/>' method="post">
                    ...
                    <div class="form-g">
                        <input class="form-control" type="email" placeholder="帳號/信箱" name="account" required
                            style="font-size: 16px;">
                    </div>
                    <div class="form-g">
                        <input class="form-control" id="password-signup" type="password" placeholder="密碼(6碼至15碼英數字)"
                            name="password" autocomplete="off" required style="font-size: 16px;">
                    </div>
                    <div class="form-g">
                    ...
                    <div class="form-g">
                        <input class="form-control" type="text" placeholder="姓名" name="name" required
                            style="font-size: 16px;">
                    </div>
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="form-g"><select name="city" aria-invalid="false" placeholder=""
    ...
    <script type="text/javascript" src="/lab_p3.js"></script>
